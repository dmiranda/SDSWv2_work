...
interface hundir_flota_interface extends Remote {
	...
	public void empieza_partida(int id) throws RemoteException;	//Se le pasa a este objeto, la referencia de otro objeto para que se comuniquen entre ellos
	public void listo() throws RemoteException;	//Un jugador avisa al otro de que está a la espera
	public void fin_partida(int ID_win) throws RemoteException;	//Un jugador avisa al otro de que ha destruido todos sus barcos
