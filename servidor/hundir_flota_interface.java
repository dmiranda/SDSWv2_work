...
interface hundir_flota_interface extends Remote {
	...
	public void empieza_partida(hundir_flota_interface contrincante) throws RemoteException;	//Se le pasa a este objeto, la referencia de otro objeto para que se comuniquen entre ellos
